...
class DataProcessor(object):
    ...
    def _read_csv(cls,input_file,quotechar=None):
        import pandas as pd
        text=pd.read_csv(input_file,header=None)
        lines=[]
...
class YelpProcessor(DataProcessor):
    ...
    '''
    import utils_glue
    data_dir='/home/zhoujing/NLP/data/classification/yelp_full/yelp_review_full_csv'
    myprocessor=utils_glue.YelpProcessor()
    dev_examples=myprocessor.get_test_examples(data_dir)
    '''
    def get_train_examples(self, data_dir):
        """See base class."""
