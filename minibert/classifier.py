...
def main():
    ...
    model = BertForSequenceClassification(model_name_or_path=args.model_name_or_path,num_labels=num_labels)
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        model = BertForSequenceClassification(args.model_name_or_path,num_labels)
...
'''
CUDA_VISIBLE_DEVICES=3 python classifier.py \
  --model_type bert \
